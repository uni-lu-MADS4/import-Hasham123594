...
readr::read_csv("data/blood_fat.csv")
...
readr::read_delim("data/blood_fat.csv",show_col_types = FALSE)
...
id :double ,group :character , weight : double , age: double , fat: double
